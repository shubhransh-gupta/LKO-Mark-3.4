...
[![Status](https://img.shields.io/badge/FLIGHT_TEST-UNDER_ACTIVE_DEVELOPMENT-ffaa00?style=for-the-badge&logo=electron&logoColor=black)](https://github.com/shubhransh-gupta/LKO-Mark-3.4)
[![macOS](https://img.shields.io/badge/PLATFORM-macOS_12+-00d2ff?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/shubhransh-gupta/LKO-Mark-3.4)
[![Engine](https://img.shields.io/badge/NEURAL_CORE-GEMINI_FLASH_LITE-00ffaa?style=for-the-badge&logo=google&logoColor=white)](https://aistudio.google.com)
[![License](https://img.shields.io/badge/PROTOCOL-MIT_STARK_INITIATIVE-ff2255?style=for-the-badge)](LICENSE)
...
```mermaid
flowchart TD
    subgraph UI ["  ⎊ HOLOGRAPHIC CLIENT LAYER  "]
        HUD["Tactical Web HUD<br/>(http://localhost:8765)"]
        MB["Obsidian MenuBar Popover<br/>(360° Radar Widget)"]
        MOB["Cloudflare Mobile Gateway<br/>(Encrypted HTTPS)"]
    end

    subgraph CORE ["  ⚡ PYTHON DAEMON & DISPATCHER  "]
        SRV["Threading HTTP Core<br/>(server.py / app.py)"]
        CONF["Config & Env Loader<br/>(config.py)"]
        LOOP["Agent Runner & Session Memory<br/>(agent/loop.py)"]
    end

    subgraph AI ["  🧠 NEURAL REASONING MATRIX  "]
        GEMINI["Google Gemini Flash-Lite<br/>(Multimodal Optical + Tool Calling)"]
    end

    subgraph SYS ["  ⚙️ NATIVE macOS SYSTEM LAYER  "]
        AS["AppleScript Dispatcher<br/>(Slack, System Events)"]
        VISION["Screen Capture Engine<br/>(Quartz / screencapture)"]
